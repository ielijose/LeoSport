...
$app->get('/destacamentos', 'getDestacamentos');

$app->run();

function getDestacamentos() {
    ...
    $sql = "SELECT id, tag, destacamento FROM destacamentos ORDER BY id";
	try {
		$db = getConnection();
		$stmt = $db->query($sql);
...
function getConnection() {
	$dbhost="localhost";
	$dbuser="ielijose_core";
	$dbpass="2512368";
	$dbname="ielijose_core";
