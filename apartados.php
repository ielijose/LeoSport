			...
			<div class="main-content">
				...
				<div class="page-content">
					<div class="page-header">
						<a class="btn btn-success btn-sm pull-right" href="apartar.php"><i class="icon-plus-sign-alt  bigger-110"></i>Apartar</a>
						<h1>Sistema de apartado</h1>
					</div><!-- /.page-header -->
								...
								<table id="inventario" class="table table-striped table-bordered table-hover">
									...
									<tbody>
										...
										<tr>													
											...
											<td>
												<a href="apartado.php?id=<? echo $venta->id; ?>"><? echo $venta->nombre ." (".$venta->ci.") ";  ?></a>
											</td>
